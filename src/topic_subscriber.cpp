...
{
    ROS_INFO("Received msg = %d", msg->stamp.sec); // Prints the 'stamp.sec' message
    ROS_INFO("Received msg = %d", msg->stamp.nsec); // Prints the 'stamp.nsec' message
    ROS_INFO("Received msg = %d", msg->data);      // Prints the 'data' message
}

int main(int argc, char **argv)
{
    ros::init(argc, argv, "topic_subscriber");  // Node main function
